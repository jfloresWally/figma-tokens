...
public class StyleDictionaryClass {
    ...
    public static let wAmber = #FDC980
    public static let wBlue100 = #BFDBFE
    public static let wBlue200 = #3B82F6
    public static let wBlue300 = #1D4ED8
    public static let wBlue50 = #EFF6FF
    public static let wCoolGray100 = #F9FAFB
    public static let wCoolGray200 = #F3F4F6
    public static let wCoolGray300 = #E5E7EB
    public static let wCoolGray400 = #D1D5DB
    public static let wCoolGray50 = #FFFFFF
    public static let wCoolGray500 = #6B7280
    public static let wCoolGray600 = #374151
    public static let wCoolGray700 = #12131F
    public static let wGreen100 = #A2E7BF
    public static let wGreen200 = #25B562
    public static let wGreen300 = #1A6B3C
    public static let wGreen50 = #E7F8EE
    public static let wLightBlue = #3293CF
    public static let wRed100 = #FECACA
    public static let wRed200 = #EF4444
    public static let wRed300 = #B91C1C
    public static let wRed50 = #FEF2F2
    public static let wScarlet = #F65E47
    public static let wYellow100 = #FEF08A
    public static let wYellow200 = #EAB308
    public static let wYellow300 = #A16207
    public static let wYellow50 = #FEFCE8
}
